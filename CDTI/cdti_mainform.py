...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(170, 390, 51, 61))
        ...
        self.formLayout_targetair.setHorizontalSpacing(0)
        self.formLayout_targetair.setVerticalSpacing(3)
        ...
        self.label_6.setPixmap(QtGui.QPixmap("pic/44.png"))
